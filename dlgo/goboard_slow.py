...
class GoString:
    def __init__(
        ...
        """
        :param color: Enum Black or White
...
class GameState:
    """
    This class captures current state of the game. It knows about the board position, the next player, the previous
    game state, and the last move that has been played.
    """
    def __init__(
            self,
            board,
